...
int main() {
	...
	//if (!status) {
	//	glGetShaderInfoLog(vertexShader, 300, nullptr, compilelog);
	//	std::cout << "Vertex shader compilation error" << compilelog<<"\n";
	//	std::cin.get();
	//}
	...
	//if (!status) {
	//	glGetShaderInfoLog(fragmentShader, 300, nullptr, compilelog);
	//	std::cout << "Vertex shader compilation error" << compilelog << "\n";
	//	std::cin.get();
	//}
	...
	//if (!status) {
	//	glGetShaderInfoLog(shaderProgram, 300, nullptr, compilelog);
	//	std::cout << "Shader linking error" << compilelog;
	//	std::cin.get();
	//}

	//deprecated code starts - This code cretes both triangles using separate vertex buffer objects
	...
	//glBufferData(GL_ARRAY_BUFFER, sizeof(vertexDataA), vertexDataA, GL_STATIC_DRAW);
	...
	//glBufferData(GL_ARRAY_BUFFER, sizeof(vertexDataB), vertexDataB, GL_STATIC_DRAW);
